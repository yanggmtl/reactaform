...
import type { BaseInputProps, DefinitionPropertyField } from "reactaform";
import {useReactaFormContext} from "reactaform";
import {StandardFieldLayout} from "reactaform";
import { CSS_CLASSES, combineClasses } from "reactaform";

// Define field shape
type DateTimeField = DefinitionPropertyField & {
...
const DateTimeInput: React.FC<DateTimeInputProps> = ({
  ...
  const onErrorRef = useRef<DateTimeInputProps["onError"] | undefined>(onError);
