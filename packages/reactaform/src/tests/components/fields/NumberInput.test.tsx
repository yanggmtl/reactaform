...
describe('IntegerInput', () => {
  ...
  it('displays initial numeric value', () => {
    const field = createMockField<IntegerField>({ type: 'integer' });
  ...
  it('validates minimum value', async () => {
    const onError = vi.fn();
    const field = createMockField<IntegerField>({ type: 'integer', min: 10 });
    const { getByRole } = renderWithProvider(
  ...
  it('validates maximum value', async () => {
    const onChange = vi.fn();
    const field = createMockField<IntegerField>({ type: 'integer', max: 100 });
    const { getByRole } = renderWithProvider(
      <IntegerInput {...baseFieldProps} field={field} value={0} onChange={onChange} />
    );
  ...
  it('shows error for required field when empty', async () => {
    const onError = vi.fn();
    const field = createMockField<IntegerField>({ type: 'integer', required: true });
    const { getByRole } = renderWithProvider(
  ...
  it('handles decimal step values', async () => {
    const onChange = vi.fn();
    const field = createMockField<IntegerField>({ type: 'integer', step: 0.1 });
    const { getByRole } = renderWithProvider(
      <IntegerInput {...baseFieldProps} field={field} value={0} onChange={onChange} />
    );
  ...
  it('validates step increments', async () => {
    const onChange = vi.fn();
    const field = createMockField<IntegerField>({ type: 'integer', step: 5 });
    const { getByRole } = renderWithProvider(
      <IntegerInput {...baseFieldProps} field={field} value={0} onChange={onChange} />
    );
  ...
  it('is disabled when disabled prop is true', async () => {
    const onChange = vi.fn();
    const field = createMockField<IntegerField>({ type: 'integer', disabled: true });
    const { getByRole } = renderWithProvider(
      <IntegerInput {...baseFieldProps} field={field} value={0} onChange={onChange} />
    );
  ...
  it('handles edge cases for zero and negative numbers', async () => {
    const onChange = vi.fn();
    const field = createMockField<IntegerField>({ type: 'integer', min: -100, max: 100 });
    const { getByRole } = renderWithProvider(
      <IntegerInput {...baseFieldProps} field={field} value={0} onChange={onChange} />
    );
  ...
  it('handles tooltip display', () => {
    const field = createMockField<IntegerField>({ type: 'integer', tooltip: 'Enter a numeric value' });
