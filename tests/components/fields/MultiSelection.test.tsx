...
describe('MultiSelection', () => {
  ...
  it('renders control with label', () => {
    const field = createMockField<OptionsField>({ type: 'multi-selection', label: 'Select Multiple', options: mockOptions });
  ...
  it('shows clear button when items are selected', () => {
    const field = createMockField<OptionsField>({ type: 'multi-selection', label: 'Select', options: mockOptions });
  ...
  it('displays tooltip icon when provided', () => {
    const field = createMockField<OptionsField>({ type: 'multi-selection', label: 'Select', options: mockOptions, tooltip: 'Choose multiple options' });
    renderWithProvider(<MultiSelection {...baseFieldProps} field={field} value={[]} />);
