...
export declare function createMockField<T extends import("../src/core/reactaFormTypes").DefinitionPropertyField = import("../src/core/reactaFormTypes").DefinitionPropertyField>(overrides?: Record<string, unknown>): T;
